  ...
  return (
    <div className="flex-1">
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-600 text-xs md:text-sm mt-4 leading-relaxed max-w-2xl">
      ...
      {/* Experience Section */}
      <div className="mb-12">
        <div className="bg-teal-700 text-white text-center py-3 mb-6 font-bold md:text-sm text-xs tracking-wider">
          EXPERIENCE
        </div>
