...
export const Modal = ({ isOpen, onClose, title, children, className = "" }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center sm:p-4">
      ...
      <div
        className={`
          relative bg-white rounded-2xl shadow-2xl w-full sm:max-w-4xl h-full sm:h-auto sm:max-h-[90vh]
      ...
      >
        ...
        {/* Content */}
        <div className="overflow-y-auto sm:max-h-[calc(90vh-80px)] max-h-[calc(100vh-80px)] px-4 sm:px-6">
          {children}
        </div>
      </div>
    </div>
