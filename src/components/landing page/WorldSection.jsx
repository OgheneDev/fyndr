...
const WorldSection = () => {
  ...
  return (
    <motion.section 
      className='px-5 py-8 md:py-17 md:px-12 bg-[#DBD0C84D] flex flex-col lg:flex-row gap-5 md:gap-12 overflow-hidden'
    ...
    >
      ...
      >
        ...
        >
          The whole world at <br className='hidden lg:block' /> your fingertips
        </motion.h1>
